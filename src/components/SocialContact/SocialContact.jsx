...
const SocialContact = () => {
  const links = [
    { href:"https://wa.me/541176513862?text=Hola%20Astral%20Vision!%20Quiero%20más%20información%20sobre%20sus%20servicios.", icon: <SiWhatsapp />, color: "#25D366", label: "WhatsApp" },
